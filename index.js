...
const displayNews = news => {
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <div><button type="button" style="height: 35px" class="btn btn-primary mt-5 ml-16 bg-blue-600" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Details<i class="fa-solid fa-arrow-right"></i></button></div>
        </div>
  ...
  // button modal
  function displayModal(modaldetails) {
    const modalfild = document.getElementById('')
  }
